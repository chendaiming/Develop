...
//	    // 只允许选择图片文件。
	...
	uploader.on( 'uploadBeforeSend', function( object,data,headers  ) {
		data.uploadType = upload_type;  //请求参数追加 uploadType传到后台
	});	 
	/*=============================================*/  
    /*================事件响应=====================*/
    /*=============================================*/
	...
	uploader.on( 'uploadSuccess', function( file,response ) {
		...
		setTimeout(function(){
			...
			switch(result.fileType){
				case 'police_excel': //警员信息导入
					break;
				case 'police_image'://警员照片上传
					updateIMG(result.filePath);
					break;
			}		 
		},2000);
	});
	
	function resetUploader(file){

...
public class TokenUtils {
	...
	public static void main(String[] args) throws Exception{
		//anlqfMP3v7W84NP8OjE0OTQzODQ5MzIyMDg6MmQzZmY2ZWVjZGY4MzM4YzQ2ZmM5OTczZjY3MjFhZmM
		String token = "anlqfGp5akBhZG1pbjoxNDk0Mzg2ODI2Nzk3OjdkNzczMzY0YWU2MGVhN2FhZDFjZTdmNjZjN2UwZDYx";
		//String[] tokenArray = TokenUtils.decodeToken(token);
		String[] tokenArray = TokenUtils.decodeTokenFromUrl(token);
	...
	public static String[] decodeTokenFromUrl(String token) throws Exception{
		...
		try {
			...
			if (tokenArray.length != 3) {
	            throw new Exception("1001:令牌解析错误!");
	        }
	        ...
	        try {
	            ...
	            if (isTokenExpired(tokenExpiryTime)) {
		            throw new Exception("1003:令牌已失效!");
		        }
	        } catch (NumberFormatException nfe) {
	        	throw new Exception("1002:令牌时效解析异常!");
	        }
		} catch (IOException e) {
			throw new Exception("1004:令牌解析异常!");
		}
		return tokenArray;
	}

...
public class SysConfigLoadResp  implements java.io.Serializable {
    ...
    private cn.showclear.www.AppService.ConfigEntry[] entries;
    ...
    public SysConfigLoadResp(
           ...
           cn.showclear.www.AppService.ConfigEntry[] entries) {
     ...
     * @return entries
     */
    public cn.showclear.www.AppService.ConfigEntry[] getEntries() {
        return entries;
    }
     ...
     * @param entries
     */
    public void setEntries(cn.showclear.www.AppService.ConfigEntry[] entries) {
        this.entries = entries;
    }

    public cn.showclear.www.AppService.ConfigEntry getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, cn.showclear.www.AppService.ConfigEntry _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.showclear.cn/AppService/", ">SysConfigLoadResp"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.showclear.cn/AppService/", "ConfigEntry"));
        elemField.setNillable(false);

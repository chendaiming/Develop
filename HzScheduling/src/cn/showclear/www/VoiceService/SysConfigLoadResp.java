...
public class SysConfigLoadResp  implements java.io.Serializable {
    ...
    private cn.showclear.www.VoiceService.ConfigEntry[] entries;
    ...
    public SysConfigLoadResp(
           ...
           cn.showclear.www.VoiceService.ConfigEntry[] entries) {
     ...
     * @return entries
     */
    public cn.showclear.www.VoiceService.ConfigEntry[] getEntries() {
        return entries;
    }
     ...
     * @param entries
     */
    public void setEntries(cn.showclear.www.VoiceService.ConfigEntry[] entries) {
        this.entries = entries;
    }

    public cn.showclear.www.VoiceService.ConfigEntry getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, cn.showclear.www.VoiceService.ConfigEntry _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.showclear.cn/VoiceService/", ">SysConfigLoadResp"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.showclear.cn/VoiceService/", "ConfigEntry"));
        elemField.setNillable(false);
